...
class HelixComplex(ParentComplex):
	...
	def __init__(self, dangleleft, dangleright, theta, zip, strand1, strand2,T, concentration, sodium, magnesium,  dataset_name, docID, name, kinetic_model):
...
def main(real_rate, theta, beta, zip, T, concentration, sodium, magnesium,  dangle, dataset_name, docID, name, kinetic_model):
	if name == "ReynaldoDissociate" :
		dangleleft = "GAA"
	...
	helix_complex = HelixComplex(dangleleft, dangleright, theta, zip, strand, strandComplement, T, concentration, sodium, magnesium , dataset_name, docID, name, kinetic_model)
	return helix_complex.rate_constant(concentration,real_rate, zip, kinetic_model)
